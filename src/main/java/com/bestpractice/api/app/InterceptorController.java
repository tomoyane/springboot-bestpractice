...
public class InterceptorController implements HandlerInterceptor {
  ...
  public InterceptorController(AuthComponent authComponent,
      CredentialProperty credentialProperty, RequestInfoComponent requestInfo) {
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
    ...
    accessLogBuilder.append("Audit log. ")
        .append("RequestId: ")
